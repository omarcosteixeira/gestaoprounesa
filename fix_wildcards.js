...
// The deployed rules need to allow regional users to read their own users doc
// And we need to add the wildcard rules for unesa and comercial back in
...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    // We allow everyone to read these, but only based on frontend filtering.
    // We'll restrict wildcards instead for regional.
`;
